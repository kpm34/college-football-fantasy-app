...
function JoinLeagueContent() {
  ...
  const refreshLeague = async (id: string) => {
    try {
      ...
      setAvailableLeagues(prev =>
        prev.map(l => (String(l.$id) === String(id) ? { ...l, ...updated } : l))
      )
      setSelectedLeague(prev =>
        prev && String(prev.$id) === String(id) ? { ...prev, ...updated } : prev
      )
    } catch {}
  }
  ...
  useEffect(() => {
    const unsubLeagues = client.subscribe(
      `databases.${DATABASE_ID}.collections.${COLLECTIONS.LEAGUES}.documents`,
      event => {
    ...
    const unsubRosters = client.subscribe(
      `databases.${DATABASE_ID}.collections.${COLLECTIONS.FANTASY_TEAMS}.documents`,
      event => {
        const payload: any = event.payload
  ...
  useEffect(() => {
    ...
    const leagueId = searchParams?.get('league') || null
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#5E2B8A] via-[#8A5EAA] to-[#8A6B4D]">
      ...
      {inviteToken && (
        <div className="bg-[#E73C7E] text-white py-2 px-4 text-center">
          <p className="text-sm">🎉 You have been invited to join a league!</p>
        </div>
      )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link
                href="/"
                className="text-xl font-bold text-[#5E2B8A] hover:text-[#8A5EAA] transition-colors"
              >
            ...
            <div className="flex items-center space-x-8">
              ...
              <Link
                href="/league/create"
                className="text-[#5E2B8A] hover:text-[#FF0080] transition-colors"
              >
                Create League
              </Link>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6">
          {filteredLeagues.map(league => (
            <div
              key={league.$id}
              className="bg-[#F5F0E6]/90 backdrop-blur-sm rounded-lg shadow-lg border border-[#5E2B8A]/20 p-6"
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-[#5E2B8A]/80 mb-3">
                    ...
                    <p>
                      Draft: {league.draftType} • {new Date(league.draftDate).toLocaleDateString()}{' '}
                      at {league.draftTime}
                    </p>
                ...
                <div className="ml-6">
                  <button
                    ...
                    disabled={
                      league.teams >= league.maxTeams || joiningLeagueId === String(league.$id)
                    }
        ...
        {filteredLeagues.length === 0 && searchTerm && !searchLoading && (
          <div className="text-center py-12">
            <div className="text-[#F5F0E6]/80">
              <svg
                className="mx-auto h-12 w-12 text-[#8A6B4D] mb-4"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div className="mt-12 text-center">
          <div className="bg-[#F5F0E6]/90 backdrop-blur-sm border border-[#FF0080]/30 rounded-lg p-6">
            <h3 className="text-lg font-medium text-[#5E2B8A] mb-2">
              Can't find the right league?
            </h3>
            <p className="text-[#5E2B8A]/80 mb-4">
              Create your own league and invite friends to join!
            </p>
            <button
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#F5F0E6] rounded-xl shadow-2xl p-8 max-w-md w-full border border-[#5E2B8A]/20">
            <div className="text-center mb-6">
              ...
              <p className="text-[#5E2B8A]/80">
                Enter the password to join "{selectedLeague.name}"
              </p>
            </div>
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                />
                {passwordError && <p className="text-[#FF0080] text-sm mt-1">{passwordError}</p>}
              </div>
