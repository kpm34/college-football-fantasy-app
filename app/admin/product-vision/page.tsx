      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[260px,1fr] items-start">
          ...
          <article className="prose prose-amber max-w-none rounded-2xl border border-amber-200 bg-white/95 shadow p-6">
            ...
            <h3 id="client-brief">1. Client Brief Highlights</h3>
            ...
            <hr />
            <h3 id="design-dev">2. Design &amp; Development Guides</h3>
            ...
            <hr />
            <h3 id="highlights">3. Product Vision Highlights</h3>
            ...
            <hr />
            <h3 id="implementation-guidelines">4. Implementation Guidelines</h3>
            ...
            <p>
              ...
              college fantasy football market through superior user experience, innovative features,
              and cutting-edge technology. Success depends on delivering rock-solid core
            ...
            <p>
              ...
              following the principles and guidelines outlined in this document, the team can create
              a platform that not only meets user needs but exceeds expectations, establishing
              itself as the definitive destination for college fantasy football.
            </p>
            <p>
