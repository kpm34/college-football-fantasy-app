    ...
    <div className="min-h-screen bg-neutral-50">
      <div className="mx-auto max-w-5xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          <Link
            href="/admin/diagrams/user-journeys"
            className="block rounded-lg p-4 bg-sky-700 text-white shadow"
          >
            <div className="font-semibold">🛣️ User Journeys</div>
            <div className="text-sm opacity-90">End‑to‑end flows · Auth · Draft · Leagues</div>
          </Link>
          <Link
            href="/admin/diagrams/entity-relations"
            className="block rounded-lg p-4 bg-indigo-700 text-white shadow"
          >
          ...
          <Link
            ...
            className="block rounded-lg p-4 bg-amber-700 text-white shadow"
          >
            <div className="font-semibold">🏈 Draft</div>
            <div className="text-sm opacity-90">User Flow · Entity Relation · API Routing</div>
          </Link>
          <Link
            href="/admin/diagrams/workflows"
            className="block rounded-lg p-4 bg-emerald-700 text-white shadow"
          >
            <div className="font-semibold">⚙️ Workflows</div>
