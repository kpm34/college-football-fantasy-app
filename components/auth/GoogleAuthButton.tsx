  ...
  return (
    <>
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 rounded-lg px-4 py-3 bg-white hover:bg-gray-50 text-gray-900 font-medium border border-gray-300 transition-all disabled:opacity-60"
      >
        {loading ? (
