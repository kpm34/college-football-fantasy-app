...
if [ ! -f ".env.local" ]; then
    ...
    echo ""
    echo "   See TOOLBOX_CLAUDE.md for the complete list of environment variables"
else
...
echo ""
echo "1. 📖 Read TOOLBOX_CLAUDE.md and TOOLBOX_CURSOR.md for all available tools"
...
echo "   - TOOLBOX_CLAUDE.md    (MCP integration for Claude Code)"
echo "   - TOOLBOX_CURSOR.md    (Development environment for Cursor AI)"
